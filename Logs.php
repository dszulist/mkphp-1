 ...
 *
 * Konfiguracja defines w php:
 *   defined('LOGS_REPORT_URL', 'https://logs.madkom.pl/report.php');
 *   defined('LOGS_REPORT_AUTH', 'username:password');
 *
 * @category MK
 * @package    MK_Logs
 * @author jkonefal
...
class MK_Logs
{
    ...
    private function _sendRequest()
    {
        ...
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, defined('LOGS_REPORT_URL') ? LOGS_REPORT_URL : '');
        ...
        curl_setopt($ch, CURLOPT_USERPWD, defined('LOGS_REPORT_AUTH') ? LOGS_REPORT_AUTH : '');
