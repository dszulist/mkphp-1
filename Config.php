 ...
 * MK_Config
 *
 * Obsługa plików konfiguracyjnych INI
 ...
 * @info      https://github.com/pear/Config_Lite/blob/master/docs/examples
 */
class MK_Config implements ArrayAccess, IteratorAggregate, Countable, Serializable
{
	 ...
	 * @throws Exception when parse ini file failed
	 */
	 ...
	 *
	 * @return void
	 * @throws Exception when file is not set,
	 *         write or readable
	 */
	 ...
	 *
	 * @return bool
	 * @throws Exception when file is not writeable
	 * @throws Exception when write failed
	 */
	 ...
	 *
	 * @return string
	 * @throws Exception when format is unknown
	 */
	 ...
	 *
	 * @return bool
	 * @throws Exception when the configuration is empty
	 *         and no default value is given
	 * @throws Exception when is not a boolean
	 ...
	 *
	 * @return void
	 * @throws Exception when given Section not exists
	 */
	 ...
	 *
	 * @throws Exception array $pairs expected
	 * @return $this
	 */
